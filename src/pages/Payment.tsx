...
//       price: "₹250",
//       duration: "3 Months",
//       features: ["All basic features", "Priority support", "Monthly webinars"],
//     },
//     premium: {
//       name: "Premium Plan",
//       price: "₹500",
//       duration: "6 Months",
//       features: ["All standard features", "24/7 support", "Exclusive content", "Certificate"],
//     },
//   }[selectedPlan];

//   if (!planDetails) {
//     return <p className="text-center mt-10 text-red-500">Invalid plan selected.</p>;
//   }
...
//         <h2 className="text-3xl font-bold text-indigo-700">Complete Your Payment</h2>
//         <p className="text-gray-500">Secure and easy payment process</p>
//       </div>
...
//       >
//         <Grid>
//           <Detail label="Student ID" value={studentId} icon={<BadgeCheck size={16} className="text-indigo-400" />} />
//           <Detail label="Full Name" value={fullName} icon={<User size={16} className="text-indigo-400" />} />
//           <Detail label="Email" value={email} icon={<Mail size={16} className="text-indigo-400" />} />
//           <Detail label="Mobile" value={mobile} icon={<Phone size={16} className="text-indigo-400" />} />
//         </Grid>
//       </Section>
...
//       >
//         <Grid>
//           <Detail label="Plan Name" value={planDetails.name} icon={<BadgeCheck size={16} className="text-purple-400" />} />
//           <Detail label="Duration" value={planDetails.duration} icon={<Calendar size={16} className="text-purple-400" />} />
//           <Detail label="Price" value={planDetails.price} icon={<CreditCard size={16} className="text-purple-400" />} />
//         </Grid>
//         <div className="mt-4 text-sm text-gray-700">
//           <span className="font-medium text-gray-600 block mb-2">Features:</span>
...
//               className={`flex items-center gap-2 p-3 border-2 rounded-xl transition-all justify-center text-sm font-medium ${
...
//             Please scan the QR from your banking app to complete the payment.
//           </p>
//         )}
//       </Section>
...
// }) => (
//   <div
//     className={`p-6 mb-6 rounded-xl shadow-md border border-gray-100 bg-gradient-to-br ${gradient}`}
//   >
//     <div className="flex items-center gap-3 mb-4">
//       <div className="w-8 h-8 bg-white/70 flex items-center justify-center rounded-full">
//         {icon}
//       </div>
